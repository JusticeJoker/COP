...
namespace Cop.Entidades
{
    public class Fisioterapeuta : Pessoa
    {
        ...
        public Fisioterapeuta(string primeiroNome, string ultimoNome, DateTime dataNascimento, Generos genero, DateTime anoInicioCarreira, int numeroStaff) : base(primeiroNome, ultimoNome, dataNascimento, genero)
        {
